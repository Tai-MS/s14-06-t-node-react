...
export const ClientHistorialCard = ({ proveedoresContratado }) => {
  //const { firstName, lastName, category, address, phone } = proveedoresContratado;
  return (
    <div className="py-2 px-2 ">
      <div className="w-[328px] h-58 bg-[#FAFFFB] rounded-xl shadow-lg border flex flex-col">
        <div className="flex items-center mb-1 mt-4">
          ...
          />
          <div className="ml-3">
            <span className="font-bold">Laura Gonzalez</span>
          </div>
        </div>
